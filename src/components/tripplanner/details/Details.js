...
export function Details({ data }) {
  ...
  const detailsleg = data.leg.map((item, index) => (
    <li key={index}>
      <DetailsLeg data={item} />
    </li>
  ));
  ...
  return (
    <div className="tripplannerdetails">
      ...
      <div className="tripplannerdetails__info">
        <div className="tripplannerdetails__departure">
          <span>departure: {data.origTimeMin}</span>
        </div>
        <div className="tripplannerdetails__arrival">
          <span>arrival: {data.destTimeMin}</span>
        </div>
        <div className="tripplannerdetails__time">
          <span>trip time: {data.tripTime} min.</span>
        </div>
        <div className="tripplannerdetails__changes">
          <span>changes:{changes}</span>
        </div>
        <div className="tripplannerdetails__fare">
          <span>fare: {formattedFare}</span>
        </div>
      </div>
